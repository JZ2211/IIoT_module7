...
SENSOR = 'sensor516'
BUCKET_NAME ='Python Stream Example'
BUCKET_KEY = 'MetalCasting2'
ACCESS_KEY = 'ist_PukgUnIswuiPFBYpc95UtD-jpb1bleGr'
BUFFER_SIZE = 3
...
try: 
     ...
     while True:
      ...
      istreamer.log(SENSOR + " bme680 Temperature(C)", temperature)
      istreamer.log(SENSOR + " bme680 Pressure(hPa)", pressure)
      istreamer.log(SENSOR + " bme680 Humidity(%RF)", humidity)
